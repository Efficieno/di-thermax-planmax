...
class Planning(Dashboard):
    ...
    __grid_root_element__ = {'type': 'branch', 'data': [{'type': 'leaf', 'data': {'views': ['charts__aEywZ_Sh'], 'activeView': 'charts__aEywZ_Sh', 'id': '1'}, 'size': 745.46875}], 'size': 1786.09375}
    ...
    charts__aEywZ_Sh = PanelComponent(component_type="charts",
                          ...
                          relations=[],
                          metadata={'chartOptions': {'legend': {'data': [], 'left': 'center', 'orient': 'horizontal', 'show': True}, 'series': [{'datasetIndex': None, 'encode': {'itemName': 'month_name', 'value': '', 'x': 'month_name', 'y': 'count'}, 'name': '', 'type': 'bar'}, {'datasetIndex': None, 'encode': {'itemName': 'month_name', 'value': '', 'x': 'month_name', 'y': 'value'}, 'name': '', 'type': 'line'}], 'title': {'left': 'left', 'subtext': '', 'text': 'Order Information', 'top': 'top'}, 'tooltip': {'formatter': '', 'show': True, 'trigger': 'item'}, 'xAxis': {'name': '', 'show': True, 'type': 'category'}, 'yAxis': [{'name': 'count', 'position': 'left', 'type': 'value'}, {'name': 'value', 'position': 'right', 'type': 'value'}]}},
