...
if TYPE_CHECKING:
    from ..xxtmx_planmax.xxplanmax_cust_dtls import XxplanmaxCustDtls
...
class XxplanmaxHeaderDtls(ERDBase):
    ...
    XxplanmaxCustDtls_site_use_id: Mapped["XxplanmaxCustDtls"] = relationship(back_populates="XxplanmaxHeaderDtls_ship_site_use_id", primaryjoin="XxplanmaxCustDtls.site_use_id==XxplanmaxHeaderDtls.ship_site_use_id", foreign_keys="[XxplanmaxCustDtls.site_use_id]", viewonly=True)
        

    

    OrgOrganizationDefinitions_organization_id: Mapped["OrgOrganizationDefinitions"] = relationship(back_populates="XxplanmaxHeaderDtls_mfg_organization_id", primaryjoin="OrgOrganizationDefinitions.organization_id==XxplanmaxHeaderDtls.mfg_organization_id", foreign_keys="[OrgOrganizationDefinitions.organization_id]", viewonly=True)
