...
class XxplanmaxLineDtls(ERDBase):
    ...
    __table_properties__ = {"ui_x_pos": 171.1843719482422, "ui_y_pos": 545.2613525390625, "colour": "#F2F3F5"}
    ...
    OeOrderLinesAll_header_id: Mapped["OeOrderLinesAll"] = relationship(back_populates="XxplanmaxLineDtls_sales_order_header_id", primaryjoin="OeOrderLinesAll.header_id==XxplanmaxLineDtls.sales_order_header_id", foreign_keys="[OeOrderLinesAll.header_id]", viewonly=True)
        

    

    OeOrderLinesAll_line_id: Mapped["OeOrderLinesAll"] = relationship(back_populates="XxplanmaxLineDtls_reference_line_id", primaryjoin="OeOrderLinesAll.line_id==XxplanmaxLineDtls.reference_line_id", foreign_keys="[OeOrderLinesAll.line_id]", viewonly=True)
        

    

    OeOrderHeadersAll_header_id: Mapped["OeOrderHeadersAll"] = relationship(back_populates="XxplanmaxLineDtls_sales_order_header_id", primaryjoin="OeOrderHeadersAll.header_id==XxplanmaxLineDtls.sales_order_header_id", foreign_keys="[OeOrderHeadersAll.header_id]", viewonly=True)
