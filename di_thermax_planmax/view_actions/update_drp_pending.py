...
class UpdateDRPPendingStatus(Action):
    ...
    mat_planning_status = Parameter(display_name="Standard / Non Standard", param_type=None, data_type=String, editable=True, show_on_form=True, values=[{"label": "Pending",
                                                                                                                                                          "value": "P"},
                                                                                                                                                         {"label": "In Progress",
                                                                                                                                                          "value": "W"},
                                                                                                                                                         {"label": "Completed",
