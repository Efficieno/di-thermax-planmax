...
class TechOCLDetails(ERDBase):
    ...
    otm_header_id = column_property(XxtmxTechOclMstrTbl.otm_header_id)
    organization_id = column_property(XxtmxTechOclMstrTbl.organization_id)
    ...
    created_by = column_property(XxtmxTechOclMstrTbl.created_by)
    creation_date = column_property(XxtmxTechOclMstrTbl.creation_date)
    last_updated_by = column_property(XxtmxTechOclMstrTbl.last_updated_by)
    last_update_date = column_property(XxtmxTechOclMstrTbl.last_update_date)
    last_update_login = column_property(XxtmxTechOclMstrTbl.last_update_login)
